...
public class EmailUtil {
    ...
    /**
     * Send real notification email to Admin.
     */
    public static void sendRealAdminNotification(String subject, String messageBody) {
        sendUserEmail("wubantetil@gmail.com", subject, messageBody);
    }

    /**
     * Send real email to ANY user (job seeker, employer, etc.)
     */
    public static void sendUserEmail(String toEmail, String subject, String messageBody) {
        String senderEmail = "wubantetil@gmail.com";
        String senderPassword = "qwmg xezv wikg dadt"; // TODO: Replace with real 16-char Gmail App Password
        ...
        try {
            ...
            message.setFrom(new javax.mail.internet.InternetAddress(senderEmail, "JobPortal System"));
