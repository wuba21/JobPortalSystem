...
public class EmailUtil {
    ...
    // Dummy methods to maintain compatibility with other controllers
    ...
    public static void sendContactMessage(String senderName, String senderEmail, String messageBody) throws MessagingException {}
    public static String generateOTP() { return ""; }
}
