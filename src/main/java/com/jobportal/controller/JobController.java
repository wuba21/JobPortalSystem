...
public class JobController {
    ...
    @FXML private ToggleButton recentJobsBtn;
    @FXML private ToggleButton longTermJobsBtn;
    ...
    private void loadJobs() {
        ...
        if (jobsContainer != null) jobsContainer.getChildren().clear();
    ...
    private VBox createJobCard(Job job) {
        ...
        // Hover effect
        card.setOnMouseEntered(e -> card.setStyle("-fx-background-color: #e0f2fe; -fx-border-radius: 10; -fx-background-radius: 10; " +
                      "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.15), 15, 0, 0, 8);"));
        card.setOnMouseExited(e -> card.setStyle("-fx-background-color: #f0fdfa; -fx-border-radius: 10; -fx-background-radius: 10; " +
                      "-fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.1), 10, 0, 0, 5);"));
        ...
        titleLabel.setOnMouseEntered(e -> titleLabel.setStyle("-fx-text-fill: #3b82f6; -fx-underline: true; -fx-cursor: hand;"));
        titleLabel.setOnMouseExited(e -> titleLabel.setStyle("-fx-text-fill: #1e293b; -fx-underline: false; -fx-cursor: hand;"));
        ...
        companyLabel.setOnMouseEntered(e -> companyLabel.setStyle("-fx-text-fill: #3b82f6; -fx-font-size: 14px; -fx-underline: true; -fx-cursor: hand;"));
        companyLabel.setOnMouseExited(e -> companyLabel.setStyle("-fx-text-fill: #64748b; -fx-font-size: 14px; -fx-underline: false; -fx-cursor: hand;"));
        ...
        skillsLabel.setStyle("-fx-background-color: #dbeafe; -fx-text-fill: #1e40af; -fx-padding: 5 10; -fx-background-radius: 15; -fx-font-size: 12px;");
        if (job.getRequirements() != null && !job.getRequirements().isEmpty()) {
            skillsLabel.setText(job.getRequirements().length() > 20 ? job.getRequirements().substring(0, 20) + "..." : job.getRequirements());
        } else {
        ...
        detailsBtn.setStyle("-fx-background-color: transparent; -fx-border-color: #0ea5e9; -fx-text-fill: #0ea5e9; -fx-font-weight: bold; -fx-cursor: hand; -fx-padding: 10; -fx-border-radius: 5;");
        detailsBtn.setOnAction(e -> showJobDetails(job));

        if (SessionManager.getCurrentUser() == null) {
            applyBtn.setText("Login to Apply");
            applyBtn.setStyle("-fx-background-color: #3b82f6; -fx-text-fill: white; -fx-font-weight: bold; -fx-cursor: hand; -fx-padding: 10;");
            ...
            if (applied) {
                ...
                applyBtn.setStyle("-fx-background-color: #94a3b8; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 10;");
            } else {
                applyBtn.setText("Apply Now");
                applyBtn.setStyle("-fx-background-color: #0ea5e9; -fx-text-fill: white; -fx-font-weight: bold; -fx-cursor: hand; -fx-padding: 10;");
    ...
    private void showJobDetails(Job job) {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/fxml/job_details.fxml"));
            javafx.scene.Parent root = loader.load();
    ...
    private Button createSocialButton(String name, String url, String color) {
        ...
        btn.setStyle("-fx-background-color: transparent; -fx-text-fill: " + color + "; -fx-underline: true; -fx-cursor: hand; -fx-font-size: 11px;");
